...
export const featuredProjects: Project[] = [
...

  {
    ...
    category: 'engineering',
    purpose:
      'A cross-platform mobile and web application built with Flutter, delivering a seamless user experience across iOS, Android, and web from a single codebase.',
    role: 'Full-Stack Developer',
